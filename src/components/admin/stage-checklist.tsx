  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <span className="text-slate-500 text-xs">{done}/{stage.checklist.length} completadas</span>
      </div>
        ...
        {stage.checklist.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-sm ${checked ? "text-green-400/80 line-through" : "text-slate-400"}`}>
                {item.label}
